...
set(MSG_I_FLAGS "-Iivactuator:/home/wong/catkin_wh/src/ivactuator/msg;-Istd_msgs:/opt/ros/kinetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/wong/catkin_wh/src/ivactuator/msg/ivactuator.msg" NAME_WE)
add_custom_target(_ivactuator_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "ivactuator" "/home/wong/catkin_wh/src/ivactuator/msg/ivactuator.msg" ""
)
...
_generate_msg_cpp(ivactuator
  "/home/wong/catkin_wh/src/ivactuator/msg/ivactuator.msg"
  "${MSG_I_FLAGS}"
  ""
...
### Generating Messages
_generate_msg_nodejs(ivactuator
  "/home/wong/catkin_wh/src/ivactuator/msg/ivactuator.msg"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/ivactuator
)

### Generating Services

### Generating Module File
_generate_module_nodejs(ivactuator
  ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/ivactuator
  "${ALL_GEN_OUTPUT_FILES_nodejs}"
)

add_custom_target(ivactuator_generate_messages_nodejs
  DEPENDS ${ALL_GEN_OUTPUT_FILES_nodejs}
)
add_dependencies(ivactuator_generate_messages ivactuator_generate_messages_nodejs)

# add dependencies to all check dependencies targets
get_filename_component(_filename "/home/wong/catkin_wh/src/ivactuator/msg/ivactuator.msg" NAME_WE)
add_dependencies(ivactuator_generate_messages_nodejs _ivactuator_generate_messages_check_deps_${_filename})

# target for backward compatibility
add_custom_target(ivactuator_gennodejs)
add_dependencies(ivactuator_gennodejs ivactuator_generate_messages_nodejs)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS ivactuator_generate_messages_nodejs)
...
if(gennodejs_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/ivactuator)
  # install generated code
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/ivactuator
    DESTINATION ${gennodejs_INSTALL_DIR}
  )
endif()
if(TARGET std_msgs_generate_messages_nodejs)
  add_dependencies(ivactuator_generate_messages_nodejs std_msgs_generate_messages_nodejs)
endif()
